...
func (s *BeatDefinition) Validate() error {
	...
	if err := func() error {
		...
		if err := (validate.Array{
			...
			MaxLength:    128,
			MaxLengthSet: true,
		}).ValidateLength(len(s.KeyPoints)); err != nil {
			return errors.Wrap(err, "array")
		}
		var failures []validate.FieldError
		for i, elem := range s.KeyPoints {
			if err := func() error {
				if err := (validate.String{
					MinLength:    0,
					MinLengthSet: false,
	...
	if err := func() error {
		if err := (validate.Int{
			...
			MultipleOfSet: false,
			MultipleOf:    0,
		}).Validate(int64(s.MinScenes)); err != nil {
	...
	if err := func() error {
		if err := (validate.Int{
			...
			MultipleOfSet: false,
			MultipleOf:    0,
		}).Validate(int64(s.MaxScenes)); err != nil {
			return errors.Wrap(err, "int")
		}
		return nil
	}(); err != nil {
...
func (s *CreateStoryPlanForm) Validate() error {
	...
	if err := func() error {
		...
		if err := (validate.Array{
			...
			MaxLength:    128,
			MaxLengthSet: true,
		}).ValidateLength(len(s.Beats)); err != nil {
			return errors.Wrap(err, "array")
		}
		var failures []validate.FieldError
...
func (s GetStoryPlansOKApplicationJSON) Validate() error {
	alias := ([]StoryPlanPreview)(s)
	if alias == nil {
		return errors.New("nil is invalid value")
	}
	var failures []validate.FieldError
